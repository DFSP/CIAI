...
@Component
public class BidProposalResourceAssembler implements
    ...
    public Resource<Proposal> toResource(Proposal proposal, User user) {
        ...
        return new Resource<>(proposal,
                linkTo(methodOn(UsersController.class).getBid(uid, pid)).withSelfRel(),
    ...
    public Resources<Resource<Proposal>> toResources(Iterable<? extends Proposal> entities, User user) {
        ...
        return new Resources<>(resources,
                linkTo(methodOn(UsersController.class).getBids(user.getId(), "")).withSelfRel(),
